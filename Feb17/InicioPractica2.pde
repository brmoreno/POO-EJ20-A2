...
class Avatar{
  ...
  void colision(){
    /*
    parte 1: desarrolla el método colisión
    el método se llama constantemente
    evalúa si el circulo de colision (rojo) está en contacto con una de las particulas 
    presentes
    si esto sucede, resta vida al Avatar
    */
  }
